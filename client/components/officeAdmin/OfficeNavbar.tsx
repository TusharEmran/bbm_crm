        ...
        <div className="flex items-center justify-center sm:justify-end gap-2 w-full sm:w-auto">
          ...
          >
            <input
              ...
              className="px-4 py-2 rounded-full text-black bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 w-full sm:w-64 md:w-72 transition-all"
            />
            <button
              type="submit"
